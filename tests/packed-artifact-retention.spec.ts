...
describe('packed artifact retention', () => {
  it('keeps the latest completed packed artifact per source branch', () => {
    const artifacts = [
      { id: 10, name: 'packed-tarball', created_at: '2026-08-28T10:00:00Z', workflow_run: { id: 100 } },
      { id: 11, name: 'packed-tarball', created_at: '2026-08-28T11:00:00Z', workflow_run: { id: 101 } },
      { id: 12, name: 'packed-tarball', created_at: '2026-08-28T12:00:00Z', workflow_run: { id: 102 } },
      { id: 20, name: 'packed-tarball', created_at: '2026-08-28T09:00:00Z', workflow_run: { id: 200 } },
      { id: 30, name: 'dsh-auth-release', created_at: '2026-08-28T13:00:00Z', workflow_run: { id: 300 } },
    ]
    const runs = new Map([
